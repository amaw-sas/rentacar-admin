...
class ReservedReservationClientNotification extends Mailable implements ShouldQueue
{
    ...
    public function build()
    {
        ...
        return $this->markdown('mail.reservation_client_notification.reserved.reserved', $reservation);
    }
}
