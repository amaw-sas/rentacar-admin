...
/**
 * Send GHL WhatsApp post-pickup message for morning pickups.
 *
 * Targets reservations picked up between yesterday 17:01 and today 05:00.
 */
class SendMorningPostReservationPickupNotification extends SendPostReservationPickupNotification
{
     ...
     * @var string
     */
    protected $signature = 'ghl:send-morning-post-reservation-pickup-notification';
     ...
     * @var string
     */
    protected $description = 'Send GHL WhatsApp post-pickup message for pickups between yesterday 17:01 and today 05:00';
    ...
    {
        $startTime = now()->subDay()->setTime(17, 1, 0)->format('Y-m-d H:i:s');
        $endTime = now()->setTime(5, 0, 0)->format('Y-m-d H:i:s');
    ...
    {
        return 'GHL Morning Post-Pickup Reminder';
    }
