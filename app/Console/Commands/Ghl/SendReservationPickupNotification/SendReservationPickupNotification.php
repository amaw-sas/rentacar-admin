...
/**
 * Base class for GHL pickup reminder notification commands.
 *
 * Uses Template Method pattern - subclasses implement:
 * - getBaseQuery(): Define the reservation query
 * - getLogPrefix(): Define the log prefix
 * - getReminderType(): Define the reminder type for message selection
 */
abstract class SendReservationPickupNotification extends Command
{
    ...
    {
        return SendGhlReminderNotificationJob::TYPE_PICKUP;
    }
