...
/**
 * Send GHL WhatsApp reminder for same-day morning pickups (11:01-15:00 window).
 */
class SendSameDayMorningReservationPickupNotification extends SendReservationPickupNotification
{
     ...
     * @var string
     */
    protected $signature = 'ghl:send-same-day-morning-reservation-pickup-notification';
     ...
     * @var string
     */
    protected $description = 'Send GHL WhatsApp reminder for same-day morning pickups (11:01-15:00 window)';
    ...
    {
        return 'GHL Same-Day Morning Pickup Reminder';
    }
    ...
    public function handle(): void
    {
        ...
        $startTime = now()->setTime(11, 1, 0)->format('Y-m-d H:i:s');
        $endTime = now()->setTime(15, 0, 0)->format('Y-m-d H:i:s');
