...
/**
 * Send GHL WhatsApp reminder for same-day late pickups (15:01-23:59 window).
 */
class SendSameDayLateReservationPickupNotification extends SendReservationPickupNotification
{
     ...
     * @var string
     */
    protected $signature = 'ghl:send-same-day-late-reservation-pickup-notification';
     ...
     * @var string
     */
    protected $description = 'Send GHL WhatsApp reminder for same-day late pickups (15:01-23:59 window)';
    ...
    {
        return 'GHL Same-Day Late Pickup Reminder';
    }
    ...
    public function handle(): void
    {
        ...
        $startTime = now()->setTime(15, 1, 0)->format('Y-m-d H:i:s');
        $endTime = now()->setTime(23, 59, 59)->format('Y-m-d H:i:s');
